...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.ndarray, test: np.ndarray) -> Tuple[RandomForestClassifier, ClassificationMetricArtifact]:
        ...
        try:
            ...
            model = RandomForestClassifier(
                ...
                criterion = cast(Literal["gini", "entropy", "log_loss"], self.model_trainer_config._criterion),
            ...
            metric_artifact = ClassificationMetricArtifact(f1_score=float(f1), precision_score=float(precision), recall_score=float(recall))
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            preprocessing_obj = cast(Pipeline, load_object(file_path=self.data_transformation_artifact.transformed_object_file_path))
